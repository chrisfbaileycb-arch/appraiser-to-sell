/**
 * Whacka client SDK — _integration-notice (stub)
 *
...
export const showIntegrationNotice = __wk('showIntegrationNotice');
export const hideIntegrationNotice = __wk('hideIntegrationNotice');
export const integrationNoticeState = __wk('integrationNoticeState');
